...
// import { StyledBootstrapGrid, ThemeProps } from './types';
import {isNumber} from '../../utils';
import makeAliases from '../../aliases';
// import { MediaAliases } from '../../media/types';

export const defaultContainerMaxWidth: any = {
    xxl: 1141,
    xl: 1140,
    lg: 960,
    md: 720,
...
export default props => {
    ...
    const getContainerMaxWidth = (breakpoint: any) => {
    ...
    const styledBootstrapGridTheme = {
